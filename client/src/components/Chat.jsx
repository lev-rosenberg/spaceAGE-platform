...
export function Chat ({
  ...
  return (
    <div className={`${styles.chat} h-full w-full flex flex-col`}>
      <Messages msgs={msgs} />
...
function Input ({ onNewMessage }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className="rounded-md w-9 h-9 p-2 text-sm font-semibold text-gray-500 shadow-sm hover:bg-gray-200 hover:text-empirica-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-empirica-500"
